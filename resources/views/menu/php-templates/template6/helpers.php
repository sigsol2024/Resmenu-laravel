...
{
    $svgOpen = '<svg class="w-5 h-5 shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">';
    ...
    return match ($icon) {
        ...
        default => '<span class="material-symbols-outlined text-xl shrink-0">language</span>',
    };
}
