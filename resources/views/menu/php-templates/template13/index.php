...
<?php $t13BrandLogo = (!empty($isTemplatePreview)) ? null : resmenu_logo_url($uploadBaseUrl ?? '', $restaurant['logo'] ?? null); ?>
<?php if ($t13BrandLogo): ?><div class="mb-4"><img src="<?php echo htmlspecialchars($t13BrandLogo); ?>" alt="<?php echo htmlspecialchars($restaurant['name']); ?>" class="h-20 w-auto object-contain mx-auto"/></div><?php else: ?>
