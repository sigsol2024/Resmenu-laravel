<?php
/**
 * Template 3: Dark Navy Blue Gradient Design
 * Modern restaurant menu template with dark navy blue gradient background
 */
...
<?php $t3BrandLogo = resmenu_logo_url($uploadBaseUrl ?? '', $restaurant['logo'] ?? null); ?>
<?php if ($t3BrandLogo): ?>
    <img src="<?php echo htmlspecialchars($t3BrandLogo); ?>" alt="<?php echo htmlspecialchars($restaurant['name']); ?>" class="h-8 w-auto object-contain max-w-[200px]">
...
<?php if (!empty($singleSectionView) && !empty($fullMenuUrl)): ?>
    <a href="<?php echo htmlspecialchars($fullMenuUrl); ?>" class="text-white text-sm font-medium hover:text-primary transition-colors">Full menu</a>
<?php endif; ?>
<?php if (!empty($fullMenuUrl)): ?>
    <a href="<?php echo htmlspecialchars($fullMenuUrl); ?>#menu" class="text-white text-sm font-medium hover:text-primary transition-colors">View menu</a>
<?php endif; ?>
<?php if (!empty($sectionsForNav) && is_array($sectionsForNav)): ?>
    <?php foreach ($sectionsForNav as $navSection): ?>
    <a href="<?php echo htmlspecialchars($fullMenuUrl); ?>#section-<?php echo htmlspecialchars($navSection['slug'] ?? ''); ?>" class="text-white text-sm font-medium hover:text-primary transition-colors"><?php echo htmlspecialchars($navSection['name'] ?? ''); ?></a>
    <?php endforeach; ?>
<?php endif; ?>
...
<?php if (!empty($singleSectionView) && !empty($fullMenuUrl)): ?>
<a href="<?php echo htmlspecialchars($fullMenuUrl); ?>" onclick="toggleCategoryMenu()" class="text-white py-2 px-4 rounded-lg hover:bg-slate-800 transition-colors">Full menu</a>
<?php endif; ?>
<?php if (!empty($fullMenuUrl)): ?>
...
<div class="@container">
<div class="@[480px]:p-4">
<div class="flex min-h-[560px] flex-col gap-6 bg-cover bg-center bg-no-repeat @[480px]:gap-8 rounded-xl md:rounded-xl items-center justify-center p-8 relative overflow-hidden group shadow-xl" data-template-preview-hero style='background-image: linear-gradient(rgba(0, 0, 0, 0.3) 0%, rgba(0, 0, 0, 0.6) 100%), url("<?php echo htmlspecialchars($heroImage); ?>");'>
...
<div class="w-full max-w-[960px]">
<div class="border-t-2 border-gray-300/30"></div>
</div>
</div>
<?php endif; ?>
<?php endif; ?>
...
<!-- CTA Footer Section -->
<div class="px-4 md:px-40 flex flex-1 justify-center py-20 bg-white text-slate-900 mt-10 rounded-t-[3rem]">
<div class="layout-content-container flex flex-col max-w-[960px] flex-1">
<div class="flex flex-col md:flex-row justify-between gap-10">
<div class="flex flex-col gap-4 max-w-sm">
<h2 class="text-3xl font-bold text-slate-900">Join the Social</h2>
...
<p class="text-sm text-gray-700"><?php echo nl2br(htmlspecialchars($restaurant['address'])); ?></p>
</div>
<?php endif; ?>
...
<?php if (!empty($restaurant['phone'])): ?>
<a href="tel:<?php echo htmlspecialchars($restaurant['phone']); ?>" class="hover:text-primary"><?php echo htmlspecialchars($restaurant['phone']); ?></a><br/>
<?php endif; ?>
<?php if (!empty($restaurant['email'])): ?>
<a href="mailto:<?php echo htmlspecialchars($restaurant['email']); ?>" class="hover:text-primary"><?php echo htmlspecialchars($restaurant['email']); ?></a>
<?php endif; ?>
</p>
</div>
<?php endif; ?>
...
<a class="w-10 h-10 rounded-full bg-slate-900 text-white flex items-center justify-center hover:bg-primary transition-colors" href="<?php echo htmlspecialchars($restaurant['instagram_url']); ?>" target="_blank" rel="noopener" title="Instagram">
...
<a class="w-10 h-10 rounded-full bg-slate-900 text-white flex items-center justify-center hover:bg-primary transition-colors" href="<?php echo htmlspecialchars($restaurant['facebook_url']); ?>" target="_blank" rel="noopener" title="Facebook">
...
<a class="w-10 h-10 rounded-full bg-slate-900 text-white flex items-center justify-center hover:bg-primary transition-colors" href="<?php echo htmlspecialchars($restaurant['twitter_url']); ?>" target="_blank" rel="noopener" title="Twitter">
...
<a class="w-10 h-10 rounded-full bg-slate-900 text-white flex items-center justify-center hover:bg-primary transition-colors" href="<?php echo htmlspecialchars($restaurant['whatsapp_link']); ?>" target="_blank" rel="noopener" title="WhatsApp">
...
<div class="border-t border-gray-300 mt-16 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-gray-600 gap-4">
<p>© <?php echo date('Y'); ?> Sigsol Resmenu. All rights reserved.</p>
</div>
</div>
</div>
</div>
