...
@if($restaurantsWithoutSubscription->isNotEmpty())
  <h2 style="font-size:1.125rem;font-weight:600;color:#111827;margin:0 0 12px;">Restaurants with no subscription</h2>
  <div class="admin-list-card" style="margin-bottom:24px;">
  ...
  <h2 style="font-size:1.125rem;font-weight:600;color:#111827;margin:0 0 12px;">All subscriptions</h2>
@endif
