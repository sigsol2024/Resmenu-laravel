...
@php($authLayout = trim($__env->yieldContent('auth_layout', 'split')))

@if($authLayout === 'centered')

<body class="bg-background-light min-h-screen flex items-center justify-center p-4 font-display antialiased">
...
<div class="flex min-h-screen lg:h-screen flex-col lg:flex-row">
    ...
    <div class="hidden lg:flex lg:w-1/2 relative overflow-hidden @yield('auth_panel_class', 'bg-primary')">

        @hasSection('auth_panel')
